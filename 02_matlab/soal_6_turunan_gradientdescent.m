...
saveas(gcf, ['Fig1_Kurva_', timestamp, '.png']);

% =========================
% FIGURE 2: Konvergensi GD
% =========================
...
saveas(gcf, ['Fig2_Konvergensi_', timestamp, '.png']);

% =========================
% Sensitivitas alpha
% =========================

alpha_big = 0.5;     % besar (biar kelihatan beda)
alpha_small = 0.002; % kecil
...
saveas(gcf, ['Fig3_Alpha_', timestamp, '.png']);
